	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    	     welBtnConfirm.attr("src", "/aboutCom/smarteditor/img/photoQuickPopup/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
    		 ...
    		 welBtnConfirm.attr("src", "/aboutCom/smarteditor/img/photoQuickPopup/btn_confirm.png");
    	 }
     }   
    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	//.net
    	sUploadURL = '/SmartEditor/FileUploaderHtml5'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 		    ...
 		    sUrl: '/SmartEditor/FileUploader',
 		    sCallback: '/SmartEditor/Callback',
