...
namespace AboutMe.Web.Front.Controllers
{
    public class ShoppingController : BaseFrontController
    {
        ...
        public ActionResult Index(Product_front_search_entity product_front_search_entity)
        {
            ...
            ViewData["P_CATE_CODE"] = _ProductService.GetCategoryDeptList("PRODUCT_TYPE", product_front_search_entity.P_CATE_CODE.Substring(0, 3), "").ToList(); //유형별
            ViewData["C_CATE_CODE"] = _ProductService.GetCategoryDeptList("SKIN_TYPE", product_front_search_entity.P_CATE_CODE.Substring(0, 3), "").ToList(); //피부타입별
            ViewData["L_CATE_CODE"] = _ProductService.GetCategoryDeptList("LINE_TYPE", product_front_search_entity.P_CATE_CODE.Substring(0, 3), "").ToList(); //라인별
