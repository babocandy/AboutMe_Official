...
namespace AboutMe.Domain.Entity.AdminReview
{
    ...
    public partial class AdminReviewEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_ADMIN_REVIEW_FREE_INFO_Result> SP_ADMIN_REVIEW_FREE_INFO(Nullable<int> iDX, ObjectParameter rET_NUM, ObjectParameter rET_MESSAGE)
        {
            var iDXParameter = iDX.HasValue ?
                new ObjectParameter("IDX", iDX) :
                new ObjectParameter("IDX", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_ADMIN_REVIEW_FREE_INFO_Result>("SP_ADMIN_REVIEW_FREE_INFO", iDXParameter, rET_NUM, rET_MESSAGE);
        }
    
        public virtual ObjectResult<SP_ADMIN_REVIEW_FREE_SEL_Result> SP_ADMIN_REVIEW_FREE_SEL(Nullable<int> pAGE, Nullable<int> pAGESIZE, string sEARCH_KEY, string sEARCH_VALUE, string mEDIA_GBN_W, string mEDIA_GBN_M, Nullable<System.DateTime> sEL_DATE_FROM, Nullable<System.DateTime> sEL_DATE_TO, string iS_PHOTO_Y, string iS_PHOTO_N, string iS_DISPLAY_Y, string iS_DISPLAY_N, ObjectParameter tOTAL)
        {
            var pAGEParameter = pAGE.HasValue ?
                new ObjectParameter("PAGE", pAGE) :
                new ObjectParameter("PAGE", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_ADMIN_REVIEW_FREE_SEL_Result>("SP_ADMIN_REVIEW_FREE_SEL", pAGEParameter, pAGESIZEParameter, sEARCH_KEYParameter, sEARCH_VALUEParameter, mEDIA_GBN_WParameter, mEDIA_GBN_MParameter, sEL_DATE_FROMParameter, sEL_DATE_TOParameter, iS_PHOTO_YParameter, iS_PHOTO_NParameter, iS_DISPLAY_YParameter, iS_DISPLAY_NParameter, tOTAL);
        }
    
        public virtual int SP_ADMIN_REVIEW_FREE_UPDATE(Nullable<int> iDX, string iS_BEST, string iS_DISPLAY, string iS_MOST_CNT, ObjectParameter rET_NUM, ObjectParameter rET_MESSAGE)
        {
            var iDXParameter = iDX.HasValue ?
                new ObjectParameter("IDX", iDX) :
                new ObjectParameter("IDX", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_ADMIN_REVIEW_FREE_UPDATE", iDXParameter, iS_BESTParameter, iS_DISPLAYParameter, iS_MOST_CNTParameter, rET_NUM, rET_MESSAGE);
        }
    }
}
